...
//        printf("Deallocate %lu\n",block_id);
        ...
        bm->read_block(cur_bitmap_block_id+this->bitmap_block_id, buffer.data());
        ...
        if (bitmap.check(cur_bitmap_block_offset)) {
            ...
            bm->write_block(cur_bitmap_block_id+this->bitmap_block_id, buffer.data());
